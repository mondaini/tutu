...
exports.createDeployment = () => {
  ...
  return new Promise((resolve, reject) => {
    ...
    return exports.retryRequest(err, 'createDeployment', params)
  })
}
...
exports.retryRequest = function (err, functionName, param) {
  logger.info("retryRequest called");
  return new Promise((resolve, reject) => {
    setTimeout(() => {
      ...
      if ((err.code == 'TooManyRequestsException' ||
          err.code == 'BadRequestException') && param.retryCount < SETTINGS.API_RETRY_LIMIT) {
